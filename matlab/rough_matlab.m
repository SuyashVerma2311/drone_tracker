...
nn_cam = CameraModel([-5,-5,2,0,0,0.25*pi], ...
                     [384,640,3], ...
                     'backgrounds/nn_back.png');
np_cam = CameraModel([-5,5,2,0,0,-0.25*pi], ...
                     [384,640,3], ...
                     'backgrounds/np_back.png');
pn_cam = CameraModel([5,-5,2,0,0,0.75*pi], ...
                     [384,640,3], ...
                     'backgrounds/pn_back.png');
pp_cam = CameraModel([5,5,2,0,0,-0.75*pi], ...
                     [384,640,3], ...
                     'backgrounds/pp_back.png');
...
while true
    ...
    % Temporary % % % % % % %
    temp = GT_sub.receive();
    updated_x = temp.Pose.Pose.Position.X;
    updated_y = temp.Pose.Pose.Position.Y;
    updated_z = temp.Pose.Pose.Position.Z;
    % % % % % % % % % % % % %
